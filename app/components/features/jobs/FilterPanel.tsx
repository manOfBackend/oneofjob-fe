...
import type { CareerType, JobFilter } from '~/lib/types';
...
export const FilterPanel = memo<FilterPanelProps>(
  ({ isExpanded, filters, companies, careers, onToggleFilter, onClearAll, onCollapse }) => {
...
const FilterSection = memo<FilterSectionProps>(
  ({ title, icon, count, items, selectedItems, onToggle, gridCols }) => {
    ...
    const badgeColor =
      icon === 'building' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800';
            ...
            >
              {icon === 'building' ? (
                ...
                <path
                  ...
                  strokeLinejoin='round'
                  strokeWidth={2}
                  d='M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2h8zM16 10h.01M16 14h.01M12 14h.01M8 14h.01M8 10h.01'
                />
              )}
            </svg>
          </div>
